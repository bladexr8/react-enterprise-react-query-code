...
const InfiniteScrollQuotes = () => {
  ...
  const {
    ...
    queryFn: async ({ pageParam = 0 }) => {
      console.log(`***Fetching More Quotes [Infinite Scroll]...`)
      const data = await fetchQuotesByCursor(pageParam)
      console.log(
        `***Finished Fetching Quotes [Infinite Scroll]... Returning Data...`
      )
      console.log(data)
      return data
    },
  ...
  return (
    <div className="py-8 max-w-2xl mx-auto">
      <div>
        ...
        {isError ? (
          <p className="text-red-900">There was a problem Fetching Quotes</p>
        ) : null}
